      ...
      <div>
        ...
        <div class="dropdown">
          <a class="grid-side-btn" style="padding-right:0" href="javascript:void(0)"
            ...
            <i class="fa fa-sort-amount-asc fa-fw" data-bind="visible: template.chartSettings.chartType() == ko.HUE_CHARTS.TYPES.TEXTLIST"></i>
            % endif
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              <a href="javascript:void(0)"
                 data-bind="css: {'active': template.chartSettings.chartType() == ko.HUE_CHARTS.TYPES.TEXTLIST}, click: function(){ template.showChart(true); template.chartSettings.chartType(ko.HUE_CHARTS.TYPES.TEXTLIST); template.showGrid(false); huePubSub.publish('gridChartForceUpdate');}"
                 class="active">
                <i class="fa fa-sort-amount-asc fa-fw"></i> ${_('Text list')}
              </a>
            </li>
            <li>
              <a href="javascript:void(0)"
